...
The source code for the `olmos` project lives at
`github <https://github.com/NarekA/olmos>`_.  You can use `git clone` to get it.

.. code-block:: bash

   git clone https://github.com/NarekA/olmos
