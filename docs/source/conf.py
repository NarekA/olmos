...
# -*- coding: utf-8 -*-
#
# olmos documentation build configuration file
#
...
version = olmos.__version__
# The full version, including alpha/beta/rc tags.
release = olmos.__release__
...
latex_documents = [
    (master_doc, 'olmos.tex', 'olmos Documentation',
     'NarekA', 'manual'),
]
...
man_pages = [
    (master_doc, 'olmos', 'olmos Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'olmos', 'olmos Documentation',
     author, 'olmos', 'One line description of project.',
     'Miscellaneous'),
]
